...
const FeaturesSection = () => {
  ...
  return (
    <Box sx={{ py: { xs: '48px', md: '72px' }, backgroundColor: '#FFFFFF' }}>
      <Container maxWidth="lg">
        ...
        <Box sx={{ 
          ...
          pb: { xs: '24px', md: 0 },
          scrollbarWidth: 'thin',
          scrollbarColor: 'rgba(76, 175, 80, 0.4) transparent',
          ...
          {features.map((feature, i) => (
            <Card 
              ...
              sx={{ 
                ...
                width: { xs: '75vw', sm: '280px', md: 'auto' },
                ...
                '&:hover': { transform: 'translateY(-8px)', boxShadow: '0 16px 32px rgba(0,0,0,0.08)' }
              }}
            >
              <Box sx={{ width: '48px', height: '48px', borderRadius: '50%', backgroundColor: '#E8F5E9', color: '#2E7D32', display: 'flex', justifyContent: 'center', alignItems: 'center', mb: '16px' }}>
                {feature.icon}
              </Box>
              <Typography variant="h3" sx={{ color: '#1B5E20', fontSize: '18px', mb: '8px', fontWeight: 700 }}>
                {feature.title}
              </Typography>
